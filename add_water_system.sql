...
BEGIN
  ...
  INSERT INTO water_sources (
    ...
    risk_zone, last_color_report, fish_kill_reports, verified_count, updated_at
  ) VALUES (
    p_name_bn, p_type, ST_SetSRID(ST_MakePoint(p_lng, p_lat), 4326)::geography, p_farmer_id,
    v_risk_zone, p_color, CASE WHEN p_fish_kill THEN 1 ELSE 0 END, 1, NOW()
  )
